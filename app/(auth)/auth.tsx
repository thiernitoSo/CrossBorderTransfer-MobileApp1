            ...
            <View style={styles.heroContent}>
              ...
              <View style={styles.featureList}>
                <View style={styles.featureItem}>
                  <Feather name="shield" size={20} color={theme.colors.surface} />
                  <Text style={styles.featureText}>Secure transactions</Text>
                </View>
                <View style={styles.featureItem}>
                  <Feather name="zap" size={20} color={theme.colors.surface} />
                  <Text style={styles.featureText}>Fast delivery</Text>
                </View>
                <View style={styles.featureItem}>
                  <Feather name="dollar-sign" size={20} color={theme.colors.surface} />
                  <Text style={styles.featureText}>Competitive rates</Text>
                </View>
                <View style={styles.featureItem}>
                  <Feather name="smartphone" size={20} color={theme.colors.surface} />
